...
% Last Modified by GUIDE v2.5 05-Aug-2019 23:36:20
...
function left_textbox_Callback(hObject, eventdata, handles)
% hObject    handle to left_textbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of left_textbox as text
%        str2double(get(hObject,'String')) returns contents of left_textbox as a double
handles.left = str2double(get(hObject,'String'))



% --- Executes during object creation, after setting all properties.
function left_textbox_CreateFcn(hObject, eventdata, handles)
% hObject    handle to left_textbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
function right_textbox_Callback(hObject, eventdata, handles)
% hObject    handle to right_textbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of right_textbox as text
%        str2double(get(hObject,'String')) returns contents of right_textbox as a double
handles.right = str2double(get(hObject,'String'))


% --- Executes during object creation, after setting all properties.
function right_textbox_CreateFcn(hObject, eventdata, handles)
% hObject    handle to right_textbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
